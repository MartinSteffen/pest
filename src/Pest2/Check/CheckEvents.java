...
class CheckEvents {
  ...
  // ÅberprÅft, ob alle Events im State s auch in der Statechart
  // definiert sind. ZurÅckgegeben wird TRUE, wenn dies der Fall ist.
    ...
    // nur im Falle eines OrStates ÅberprÅfen
