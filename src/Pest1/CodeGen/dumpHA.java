 ...
 * automaton.
 *
 * @version $Id: dumpHA.java,v 1.23 1999-02-28 17:34:10 swtech25 Exp $
 * @author Marcel Kyas
 */
package codegen;
...
public class dumpHA
{
       ...
       throws CodeGenException
  {
    ...
    if (tr == null) {
      ret += util.printlnPP(lvl, "// no outgoing transitions found") +
       ...
       throws CodeGenException, IOException
  {
    ...
    f.write(
	    ...
	    util.printlnPP(0, " */") +
	    util.printlnPP(0, "public class Automaton {") +
	    util.printlnPP(0, "") +
	    util.printlnPP(1, "/**") +
	    ...
	    dumpDefaultStates(2, p, S1.state) +
	    util.printlnPP(1, "}") +
	    util.printlnPP(1, "") +
	    util.printlnPP(1, "/**") +
